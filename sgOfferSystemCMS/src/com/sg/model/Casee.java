...
public class Casee {
	...
	public Casee(int id, String pno, int category_id, int brandId,
			String model, double cost_price, double mini_price,
	...
	public String toString() {
		return "Casee [id=" + id + ", pno=" + pno + ", brandId=" + brandId
				+ ", model=" + model + ", media_price=" + media_price
