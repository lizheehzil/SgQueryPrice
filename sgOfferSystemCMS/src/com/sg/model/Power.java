...
public class Power {
	...
	private String other_spec; // '其他参数',
	...
	public String toString() {
		return "Power [id=" + id + ", pno=" + pno + ", category_id="
				+ category_id + ", brandId=" + brandId + ", model=" + model
				+ ", power=" + power + ", other_spec=" + other_spec
				+ ", cost_price=" + cost_price + ", mini_price=" + mini_price
				+ ", inner_price=" + inner_price + ", media_price="
				+ media_price + ", jd_price=" + jd_price + ", vip_price="
				+ vip_price + ", create_time=" + create_time + ", update_time="
				+ update_time + ", remark=" + remark + ", is_display="
				+ is_display + "]";
	}
	public Power(int id, String pno, int category_id, int brandId,
			String model, double power, String other_spec, double cost_price,
