...
public class Monitor {
	...
	public Monitor(int id, String pno, int category_id, int brandId,
			String model, String size, String panel, double cost_price,
	...
	public String toString() {
		return "Monitor [id=" + id + ", pno=" + pno + ", category_id="
				+ category_id + ", brandId=" + brandId + ", model=" + model
				+ ", size=" + size + ", panel=" + panel + ", cost_price="
				+ cost_price + ", mini_price=" + mini_price + ", inner_price="
				+ inner_price + ", media_price=" + media_price + ", jd_price="
				+ jd_price + ", vip_price=" + vip_price + ", create_time="
				+ create_time + ", update_time=" + update_time + ", remark="
				+ remark + ", is_display=" + is_display + "]";
	}
