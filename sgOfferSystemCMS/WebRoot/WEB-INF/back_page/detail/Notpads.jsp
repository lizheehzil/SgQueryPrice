...
<body>
	...
	<!-- 主界面 -->
	<div class="container">
		<form action="editnotpads.do" method="post">
				...
				<div class="row">
					...
					<div class="panel panel-primary">
						...
						<div class="row product-detail text-center">
							...
							<div class="col-xs-6 col-sm-4 col-md-3 product-attr">
								<div class="att-name">配置代码</div>
								<div class="input-group input-box">
									<input type="text" class="form-control text-center"
										name="configuration_code" value="${item.configuration_code}" />
								</div>
							</div>
							<div class="col-xs-6 col-sm-4 col-md-3 product-attr">
								<div class="att-name">CPU</div>
								<div class="input-group input-box">
									<input type="text" class="form-control text-center"
							...
							<div class="col-xs-6 col-sm-4 col-md-3 product-attr">
								<div class="att-name">显卡</div>
								<div class="input-group input-box">
									<input type="text" class="form-control text-center"
										name="graphics_card" value="${item.graphics_card}" />
								</div>
							</div>
							<div class="col-xs-6 col-sm-4 col-md-3 product-attr">
								<div class="att-name">内存</div>
								<div class="input-group input-box">
									<input type="text" class="form-control text-center"
										name="memories" value="${item.memories}" />
								</div>
							</div>
							<div class="col-xs-6 col-sm-4 col-md-3 product-attr">
								<div class="att-name">硬盘</div>
								<div class="input-group input-box">
									<input type="text" class="form-control text-center"
										name="disk" value="${item.disk}" />
								</div>
							</div>
							<div class="col-xs-6 col-sm-4 col-md-3 product-attr">
								<div class="att-name">屏幕尺寸</div>
								<div class="input-group input-box">
									<input type="text" class="form-control text-center"
										name="screen_size" value="${item.screen_size}" />
								</div>
							</div>
							<div class="col-xs-6 col-sm-4 col-md-3 product-attr">
								<div class="att-name">键盘背光</div>
								<div class="input-group input-box">
									<input type="text" class="form-control text-center"
										name="keypad_backlight" value="${item.keypad_backlight}" />
								</div>
							</div>
							<div class="col-xs-6 col-sm-4 col-md-3 product-attr">
								<div class="att-name">光驱</div>
								<div class="input-group input-box">
									<input type="text" class="form-control text-center"
										name="Cd_drive" value="${item.cd_drive}" />
								</div>
							</div>
							<div class="col-xs-6 col-sm-4 col-md-3 product-attr">
								<div class="att-name">M_2</div>
								<div class="input-group input-box">
									<input type="text" class="form-control text-center"
										name="M_2" value="${item.m_2}" />
								</div>
							</div>
							<div class="col-xs-6 col-sm-4 col-md-3 product-attr">
								<div class="att-name">MSATA</div>
								<div class="input-group input-box">
									<input type="text" class="form-control text-center"
										name="MSATA" value="${item.MSATA}" />
								</div>
							</div>

							<div class="col-xs-6 col-sm-4 col-md-3 product-attr">
								<div class="att-name">行货进价</div>
								<div class="input-group input-box">
									<input type="text" class="form-control text-center"
										name="standard_price" value="${item.standard_price}" />
								</div>
							</div>
							
							<div class="col-xs-6 col-sm-4 col-md-3 product-attr">
								<div class="att-name">外区货进价</div>
								<div class="input-group input-box">
									<input type="text" class="form-control text-center"
										name="unstandard_price" value="${item.unstandard_price}" />
								</div>
							</div>
							...
							<div class="col-xs-6 col-sm-4 col-md-3 product-attr">
								<div class="att-name">指导价</div>
								<div class="input-group input-box">
									<input type="text" class="form-control text-center"
										name="guide_price" value="${item.guide_price}" />
								</div>
							</div>
							<div class="col-xs-6 col-sm-4 col-md-3 product-attr">
							...
							<div class="col-xs-6 col-sm-4 col-md-3 product-attr">
								...
								<div class="input-group input-box"  style="width:100%;">
									<select class="form-control text-center" name="is_display">
										<option value="1"
											<c:if test="${item.is_display==1}">selected="selected"</c:if>>可见</option>
										<option value="0"
											<c:if test="${item.is_display==0}">selected="selected"</c:if>>不可见</option>
									</select>
								</div>
							</div>
						</div>
