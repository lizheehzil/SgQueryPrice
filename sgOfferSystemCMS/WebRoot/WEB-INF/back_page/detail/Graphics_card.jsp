...
<body>
	...
	<div class="container">
		<form action="edit.do" method="post">
			<fieldset disabledgraphics="disabled">
				<div class="row">
					...
					<div class="panel panel-primary">
						...
						<div class="row product-detail text-center">
							...
							<div class="col-xs-6 col-sm-4 col-md-3 product-attr">
								<div class="att-name">显示核心</div>
								<div class="input-group input-box">
									<input type="text" class="form-control text-center"
										name="display_core" value="${item.display_core}" />
								</div>
							</div>
							...
							<div class="col-xs-6 col-sm-4 col-md-3 product-attr">
								...
								<div class="input-group input-box">
									<input type="text" class="form-control text-center"
										name="other_spec" value="${item.other_spec}" />
								</div>
							</div>
							<div class="col-xs-6 col-sm-4 col-md-3 product-attr">
