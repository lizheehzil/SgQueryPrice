			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="dropdown">
							<a href="back.login" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
								后台入口
								<span class="caret"></span></a>
							<ul class="dropdown-menu">
								<li>
									<a href="front.login">前台入口</a>
								</li>
							</ul>
						</li>
					</ul>
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-offset-1 col-xs-10 col-sm-offset-2 col-sm-8 col-md-offset-3 col-md-6" style="background-color: #ecf0f1;border-radius: 10px;">
					<form class="form-horizontal" action="backlogin.login" method="post">
						<fieldset>
							<br/>
