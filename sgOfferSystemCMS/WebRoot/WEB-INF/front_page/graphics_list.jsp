		...
		<div class="container">
			<div class="row">
				<div class="col-md-offset-8 col-md-4">
					<form action="searchgraphics.shtml" method="post">
			...
			<div class="row">
				<div class="panel panel-default">
					<div class="panel-body">
						<div class="col-xs-12">
							<h4>系列:</h4></div>
						<div class="col-xs-3 col-sm-3"><a href="getAllGraphics.shtml?term=TAITAN">TAITAN</a></div>
						<div class="col-xs-3 col-sm-3"><a href="getAllGraphics.shtml?term=GTX">GTX</a></div>
						<div class="col-xs-3 col-sm-3"><a href="getAllGraphics.shtml?term=GT">GT</a></div>
						<div class="col-xs-3 col-sm-3"><a href="getAllGraphics.shtml?term=">全部</a></div>
						<div class="col-xs-12">
							<hr />
							<h4>品牌:</h4></div>
							<c:forEach items="${graphicsbrand }" var="brand">
										<div class="col-xs-3 col-sm-3"><a href="getAllGraphics.shtml?${term}&term2=${brand.id}">${brand.name}</a></div>
							</c:forEach>
					</div>
				</div>
			</div>
					...
					<div class="col-xs-6 col-sm-3 col-md-3">
						<div class="thumbnail product-item">
							...
							<div class="caption">
								...
								<p>
									<a href="detail_graphics.shtml?id=${item.id}&brand=${item.brand}&category=${item.category}" class="btn btn-default btn-block" role="button">详情</a>
								</p>
							</div>
						</div>
					</div>
