		...
		<div class="container">
			<div class="row">
				<div class="col-md-offset-8 col-md-4">
					<form action="searchdisk.shtml" method="post">
			...
			<div class="row">
				<div class="panel panel-default">
					<div class="panel-body">
						...
						<div class="col-xs-3 col-sm-3"><a href="getAllDisk.shtml?term=120">120G以下</a></div>
						<div class="col-xs-3 col-sm-3"><a href="getAllDisk.shtml?term=240">240G</a></div>
						<div class="col-xs-3 col-sm-3"><a href="getAllDisk.shtml?term=500">500G</a></div>
						<div class="col-xs-3 col-sm-3"><a href="getAllDisk.shtml?term=1000">1T及更多</a></div>
						<div class="col-xs-12">
							<hr />
							<h4>品牌:</h4></div>
								<c:forEach items="${diskbrand }" var="brand">
								<div class="col-xs-3 col-sm-3"><a href="getAllDisk.shtml?${term}&term2=${brand.id}">${brand.name}</a></div>
							</c:forEach>
						...
						<div class="col-xs-3 col-sm-3"><a href="getAllDisk.shtml?${term}${term2}&term3=SATA3">SATA3</a></div>
						<div class="col-xs-3 col-sm-3"><a href="getAllDisk.shtml?${term}${term2}&term3=mSATA">mSATA</a></div>
						<div class="col-xs-3 col-sm-3"><a href="getAllDisk.shtml?${term}${term2}&term3=USB">USB3.0</a></div>
						<div class="col-xs-3 col-sm-3"><a href="getAllDisk.shtml?${term}${term2}&term3=">其他</a></div>
					</div>
				</div>
			</div>
					...
					<div class="col-xs-6 col-sm-3 col-md-3">
						...
						<c:if test="${item.is_display eq 3}">
							...
							<div class="caption">
								...
								<p>
									<a href="detail_disk.shtml?id=${item.id}&brand=${item.brand}&category=${item.category}" class="btn btn-default btn-block" role="button">详情</a>
								</p>
							</div>
						</div>
					</div>
