		...
		<div class="container">
			<div class="row">
				<div class="col-md-offset-8 col-md-4">
					<form action="searchkeymouse.shtml" method="post">
			...
			<div class="row">
				<div class="panel panel-default">
					<div class="panel-body">
						...
						<div class="col-xs-3 col-sm-3"><a href="getAllKeymouse.shtml?term=29001">鼠标</a></div>
						<div class="col-xs-3 col-sm-3"><a href="getAllKeymouse.shtml?term=29002">键盘</a></div>
						<div class="col-xs-3 col-sm-3"><a href="getAllKeymouse.shtml?term=29003">键鼠套装</a></div>
						<div class="col-xs-3 col-sm-3"><a href="getAllKeymouse.shtml?term=29004">无线套装</a></div>
						<div class="col-xs-12">
							<hr />
							<h4>品牌:</h4></div>
							<c:forEach items="${keymousebrand }" var="brand">
									<div class="col-xs-3 col-sm-3"><a href="getAllKeymouse.shtml?${term}&term2=${brand.id}">${brand.name}</a></div>
							</c:forEach>
					</div>
				</div>
			</div>
					...
					<div class="col-xs-6 col-sm-3 col-md-3">
						...
						<c:if test="${item.is_display eq 3}">
							...
							<div class="caption">
								...
								<p>Type:${item.category}<br/> 价格:￥ ${item.media_price}
								</p>
								<p>
									<a href="detail_keymouse.shtml?id=${item.id}&brand=${item.brand}&category=${item.category}" class="btn btn-default btn-block" role="button">详情</a>
								</p>
							</div>
						</div>
					</div>
