		...
		<div class="container">
			<div class="row">
				<div class="col-md-offset-8 col-md-4">
					<form action="searchboard.shtml" method="post">
			...
			<div class="row">
				<div class="panel panel-default">
					<div class="panel-body">
						...
						<div class="col-xs-3 col-sm-3"><a href="getAllBoard.shtml?term=1151">1151</a></div>
						<div class="col-xs-3 col-sm-3"><a href="getAllBoard.shtml?term=1150">1150</a></div>
						<div class="col-xs-3 col-sm-3"><a href="getAllBoard.shtml?term=">其他</a></div>
						<div class="col-xs-12">
							<hr />
							<h4>芯片类型:</h4></div>

						<div class="col-xs-3 col-sm-3"><a href="getAllBoard.shtml?${term}&term2=Z170">Z170</a></div>
						<div class="col-xs-3 col-sm-3"><a href="getAllBoard.shtml?${term}&term2=Z50">Z50</a></div>
						<div class="col-xs-3 col-sm-3"><a href="getAllBoard.shtml?${term}&term2=B150">B150</a></div>
						<div class="col-xs-3 col-sm-3"><a href="getAllBoard.shtml?${term}&term2=Z97">Z97</a></div>
						<div class="col-xs-3 col-sm-3"><a href="getAllBoard.shtml?${term}&term2=B85">B85</a></div>
						<div class="col-xs-3 col-sm-3"><a href="getAllBoard.shtml?${term}&term2=">其他</a></div>

						<div class="col-xs-12">
							<hr/>
							<h4>品牌:</h4></div>
							<c:forEach items="${boardbrand }" var="brand">
								<div class="col-xs-3 col-sm-3"><a href="getAllBoard.shtml?${term}${term2}&term3=${brand.id}">${brand.name}</a></div>
							</c:forEach>
					</div>
			</div>
			</div>
					...
					<div class="col-xs-6 col-sm-3 col-md-3">
						...
						<c:if test="${item.is_display eq 3}">
							...
							<div class="caption">
								...
								<p>
									<a href="detail_board.shtml?id=${item.id}&brand=${item.brand}&category=${item.category}" class="btn btn-default btn-block" role="button">详情</a>
								</p>
							</div>
						</div>
					</div>
