		...
		<div class="container">
			<div class="row">
				<div class="col-md-offset-8 col-md-4">
					<form action="searchcasee.shtml" method="post">
			...
			<div class="row">
				<div class="panel panel-default">
					<div class="panel-body">
						<div class="col-xs-12">
							<h4>品牌:</h4></div>
								<c:forEach items="${caseebrand }" var="brand">
								<div class="col-xs-3 col-sm-3"><a href="getAllDisk.shtml?&term1=${brand.id}">${brand.name}</a></div>
							</c:forEach>
					</div>
				</div>
			</div>
					...
					<div class="col-xs-6 col-sm-3 col-md-3">
						...
						<c:if test="${item.is_display eq 3}">
							...
							<div class="caption">
								...
								<p>
									<a href="detail_casee.shtml?id=${item.id}&brand=${item.brand}&category=${item.category}" class="btn btn-default btn-block" role="button">详情</a>
								</p>
							</div>
						</div>
					</div>
