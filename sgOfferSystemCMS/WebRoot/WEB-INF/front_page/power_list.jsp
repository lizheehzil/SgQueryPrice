		...
		<div class="container">
			<div class="row">
				<div class="col-md-offset-8 col-md-4">
					<form action="searchpower.shtml" method="post">
			...
			<div class="row">
				<div class="panel panel-default">
					<div class="panel-body">
						...
						<div class="col-xs-3 col-sm-3"><a href="getAllPower.shtml?term=<300">300W以下</a></div>
						<div class="col-xs-3 col-sm-3"><a href="getAllPower.shtml?term=>300 and power<=400">301——400W</a></div>
						<div class="col-xs-3 col-sm-3"><a href="getAllPower.shtml?term=>400 and power<=700">401——700W</a></div>
						<div class="col-xs-3 col-sm-3"><a href="getAllPower.shtml?term=>700">其他</a></div>
						
						<div class="col-xs-12">
							<hr/><h4>品牌:</h4></div>
							<c:forEach items="${powerbrand }" var="brand">
								<div class="col-xs-3 col-sm-3"><a href="getAllPower.shtml?${term}&term2=${brand.id}">${brand.name}</a></div>
							</c:forEach>
					</div>
				</div>
			</div>
				...
				<c:forEach items="${pagination.list }" var="item">
					<div class="col-xs-6 col-sm-3 col-md-3">
						...
						<c:if test="${item.is_display eq 3}">
							...
							<div class="caption">
								<h3>${item.model}</h3>
								<p>品牌:${item.brand}<br/> 价格:￥ ${item.media_price}
	
								</p>
								<p>
									<a href="detail_power.shtml?id=${item.id}&brand=${item.brand}&category=${item.category}" class="btn btn-default btn-block" role="button">详情</a>
								</p>
							</div>
						</div>
					</div>
