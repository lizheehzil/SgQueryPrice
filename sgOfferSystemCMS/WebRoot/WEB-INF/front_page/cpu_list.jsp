		...
		<div class="container">
			<div class="row">
				<div class="col-md-offset-8 col-md-4">
					<form action="searchcpu.shtml" method="post">
			...
			<div class="row">
				<div class="panel panel-default">
					<div class="panel-body">
						<div class="col-xs-12">
							<h4>CPU:</h4></div>
								<div class="col-xs-3 col-sm-3"><a href="getAllCPU.shtml?term=i7">i7</a></div>
								<div class="col-xs-3 col-sm-3"><a href="getAllCPU.shtml?term=i5">i5</a></div>
								<div class="col-xs-3 col-sm-3"><a href="getAllCPU.shtml?term=i3">i3</a></div>
								<div class="col-xs-3 col-sm-3"><a href="getAllCPU.shtml?term=">其他</a></div>
					</div>
				</div>
			</div>
					...
					<div class="col-xs-6 col-sm-3 col-md-3">
						...
						<c:if test="${item.is_display eq 3}">
							...
							<div class="caption">
								...
								<p>
									<a href="detail_cpu.shtml?id=${item.id}&brand=${item.brand}&category=${item.category}" class="btn btn-default btn-block" role="button">详情</a>
								</p>
							</div>
						</div>
					</div>
