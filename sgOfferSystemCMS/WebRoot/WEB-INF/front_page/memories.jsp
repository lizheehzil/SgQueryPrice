		...
		<div class="container">
			<div class="row">
				<div class="col-md-offset-8 col-md-4">
					<form action="searchmemories.shtml" method="post">
			...
			<div class="row">
				<div class="panel panel-default">
					<div class="panel-body">
						...
						<div class="col-xs-3 col-sm-3"><a href="getAllMemories.shtml?term=4">4G</a></div>
						<div class="col-xs-3 col-sm-3"><a href="getAllMemories.shtml?term=8">8G</a></div>
						<div class="col-xs-3 col-sm-3"><a href="getAllMemories.shtml?term=16">16G</a></div>
						<div class="col-xs-3 col-sm-3"><a href="getAllMemories.shtml?term=">其他</a></div>
						<div class="col-xs-12">
							<hr />
							<h4>品牌:</h4></div>
							<c:forEach items="${memoriesbrand }" var="brand">
									<div class="col-xs-3 col-sm-3"><a href="getAllMemories.shtml?${term}&term3=${brand.id}">${brand.name}</a></div>
							</c:forEach>
					</div>
				</div>
			</div>
					...
					<div class="col-xs-6 col-sm-3 col-md-3">
						...
						<c:if test="${item.is_display eq 3}">
							...
							<div class="caption">
								...
								<p>
									<a href="detail_memories.shtml?id=${item.id}&brand=${item.brand}&category=${memories.category}" class="btn btn-default btn-block" role="button">详情</a>
								</p>
							</div>
						</div>
					</div>
