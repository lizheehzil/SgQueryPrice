		...
		<div class="container">
			<div class="row">
				<div class="col-md-offset-8 col-md-4">
					<form action="searchradiator.shtml" method="post">
			...
			<div class="row">
				<div class="panel panel-default">
					<div class="panel-body">
						...
						<div class="col-xs-3 col-sm-3"><a href="getAllRadiator.shtml?term=笔记本">笔记本</a></div>
						<div class="col-xs-3 col-sm-3"><a href="getAllRadiator.shtml?term=主机">主机</a></div>
						<div class="col-xs-3 col-sm-3"><a href="getAllRadiator.shtml?term=">全部</a></div>
						<div class="col-xs-12">
							<hr/><h4>品牌:</h4></div>
							<c:forEach items="${radiatorbrand }" var="brand">
								<div class="col-xs-3 col-sm-3"><a href="getAllRadiator.shtml?${term}&term2=${brand.id}">${brand.name}</a></div>
							</c:forEach>
					</div>
				</div>
			</div>
					...
					<div class="col-xs-6 col-sm-3 col-md-3">
						...
						<c:if test="${item.is_display eq 3}">
							...
							<div class="caption">
								...
								<p>
									<a href="detail_radiator.shtml?id=${item.id}&brand=${item.brand}&category=${item.category}" class="btn btn-default btn-block" role="button">详情</a>
								</p>
							</div>
						</div>
					</div>
