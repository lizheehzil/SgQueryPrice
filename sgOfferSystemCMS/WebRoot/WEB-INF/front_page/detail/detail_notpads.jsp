...
${arg.model }</h3>
					...
					<div class="panel-body">
						...
						<strong>配置代码:&nbsp;</strong>${arg.configuration_code }<br/><br/>
						<strong>CPU:&nbsp;</strong>${arg.CPU }<br/><br/>
						<strong>显卡:&nbsp;</strong>${arg.graphics_card }<br/><br/>
						<strong>硬盘:&nbsp;</strong>${arg.disk }<br/><br/>
						<strong>内存:&nbsp;</strong>${arg.memories }<br/><br/>
						<strong>屏幕大小:&nbsp;</strong>${arg.screen_size }<br/><br/>
						<strong>键盘背光:&nbsp;</strong>${arg.keypad_backlight }<br/><br/>
						<strong>光驱:&nbsp;</strong>${arg.cd_drive }<br/><br/>
						<strong>M_2:&nbsp;</strong>${arg.m_2}<br/><br/>
						<strong>msata:&nbsp;</strong>${arg.MSATA }<br/><br/>
