		...
		<div class="container">
			<div class="row">
				<div class="col-md-offset-8 col-md-4">
					<form action="searchnotpads.shtml" method="post">
			...
			<div class="row">
				<div class="panel panel-default">
					<div class="panel-body">
						...
						<div class="col-xs-3 col-sm-3"><a href="searchnotpads.shtml?term=i7">i7</a></div>
						<div class="col-xs-3 col-sm-3"><a href="searchnotpads.shtml?term=i5">i5</a></div>
						<div class="col-xs-3 col-sm-3"><a href="searchnotpads.shtml?term=i3">i3</a></div>
						<div class="col-xs-3 col-sm-3"><a href="searchnotpads.shtml?term=">全部</a></div>
						<div class="col-xs-12">
							<hr />
							<h4>显卡:</h4></div>

						<div class="col-xs-3 col-sm-3"><a href="searchnotpads.shtml?term=GTX%20">GTX</a></div>
						<div class="col-xs-3 col-sm-3"><a href="searchnotpads.shtml?term=GT%20">GT</a></div>
						<div class="col-xs-3 col-sm-3"><a href="searchnotpads.shtml?term=AMD">AMD</a></div>
						<div class="col-xs-3 col-sm-3"><a href="searchnotpads.shtml?term=">全部</a></div>

						<div class="col-xs-12">
							<hr/>
							<h4>品牌:</h4></div>
							<c:forEach items="${notpadsbrand }" var="brand">
								<div class="col-xs-3 col-sm-3"><a href="searchnotpads.shtml?term=${brand.id}">${brand.name}</a></div>
							</c:forEach>
							
						<div class="col-xs-12">
							<hr />
							<h4>价格排序:</h4></div>
							<div class="col-xs-3 col-sm-3"><a href="searchnotpads.shtml?${term}&term4=asc">升序</a></div>
							<div class="col-xs-3 col-sm-3"><a href="searchnotpads.shtml?${term}&term4=desc">降序</a></div></div>
					</div>
				</div>
			</div>
				...
				<c:forEach items="${pagination.list }" var="item">
					...
					<div class="col-xs-6 col-sm-3 col-md-3">
						...
						<c:if test="${item.is_display eq 3}">
							...
							<div class="caption">
								<h3>${item.model}</h3>
								<p>品牌:${item.brand}<br/>价格:￥ ${item.jd_price}
	
								</p>
								<p>
									<a href="detail_notpads.shtml?id=${item.id}&brand=${item.brand}&category=${item.category}" class="btn btn-default btn-block" role="button">详情</a>
								</p>
							</div>
						</div>
					</div>
